...
{{--    </div>--}}
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/po/create/store" method="POST">
                    @csrf
{{--                    <div class="form-row">--}}
...
{{--                    </div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="details" placeholder="Please specify the detils of your order" name="details"></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputQuantity">Quantity</label>
                            <input type="number" min="1" class="form-control" id="qty" oninput="getInputValue()" name="quantity" min=1>
                        </div>
                        <div class="form-group col-md-4">
