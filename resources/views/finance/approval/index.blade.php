                ...
                <tr>
                    ...
                    <td>
                        @if($approval->status_id == '5')
                           Order is canceled
                        @else
                            @if($approval->finance == '0')
                                Declined
                            @elseif($approval->supervisor == '0')
                                Declined By Supervisor
                            @elseif($approval->finance == '1')
                                Approved
                            @elseif(is_null($approval->finance))
                                <form action="/f/po/{{$approval->id}}/approval" method="POST">
                                    @csrf
